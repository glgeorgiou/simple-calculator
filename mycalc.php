...
if ( (isset($_POST['num1']) && !empty($_POST['num1'])) || (isset($_POST['num2']) && !empty($_POST['num2']))) {
	$result = calc($_POST['num1'], $_POST['num2'], $_POST['op']);
	} 
  ...
  <table border="0">
    ...
    <tr>
      ...
      <td id="op"><label for="select"></label>
        <select class="fieldborder" name="op" id="select">
          <option>+</option>
          <option>-</option>
          <option>*</option>
          <option>/</option>
    ...
    <tr>
	  ...
	  if (isset($_POST['num1']) and isset($_POST['op']) and isset($_POST['num2']))
echo '<b>Result</b><br /> '.$_POST['num1']. ' '. $_POST['op']. ' ' .$_POST['num2']. " = $result"; 	  
	  ?></td>
    </tr>
  </table>
</form>
